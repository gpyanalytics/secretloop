...
**Revision 2 — August 2026.** Supersedes revision 1. Moved to `docs/project/` in
September 2026 without changing its analysis; the rule count was updated to the
current 110. The correction in §4 is
